...
export default function ResumePage() {
  ...
  const t = (value: Parameters<typeof resolveText>[0]) => resolveText(value, language);
                  ...
                  <div key={t(project.title)} className={styles.projectItem}>
                    ...
                    {project.meta?.link && (
                      <a
                        ...
                        rel="noreferrer"
                      >
                        {language === 'fa' ? 'مشاهده پروژه' : 'View Project'}
                      </a>
                    )}
                  </div>
                ))}
            ...
            <section className={styles.card} id="languages">
              ...
              <div className={styles.languagesList}>
                {resume.languages.map((lang) => (
                  <div key={t(lang.name)} className={styles.languageItem}>
